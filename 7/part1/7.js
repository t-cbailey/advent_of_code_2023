    ...
    .map((hand) => {
      ...
      for (key in cards) {
        if (Object.keys(cards).length === 1) {
          ...
          hand.push("6");
        } else if (cards[key] === 3 && Object.keys(cards).length === 2) {
          hand.push("5");
        } else if (cards[key] === 3 && Object.keys(cards).length === 3) {
          hand.push("4");
          break;
        } else if (Object.keys(cards).length === 3 && maxCards < 3) {
          hand.push("3");
          break;
        } else if (Object.keys(cards).length === 4) {
          hand.push("2");
          break;
        } else if (Object.keys(cards).length === 5) {
          hand.push("1");
          break;
        }
      }
